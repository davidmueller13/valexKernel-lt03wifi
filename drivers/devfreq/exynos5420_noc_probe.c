...
unsigned int start_nocp_list(struct list_head *target_list)
{
...
unsigned int stop_nocp_list(struct list_head *target_list)
{
	struct nocp_info *tmp_nocp;
	unsigned int tmp;
...
struct nocp_cnt *check_get_cnt_done(struct list_head *target_list,
					struct nocp_cnt *nocp_cnt)
{
	struct nocp_info *tmp_nocp;
...
unsigned int set_nocp_packet_evt(struct list_head *target_list)
{
	struct nocp_info *tmp_nocp;
	unsigned int tmp;
...
unsigned int nocp_get_aver_cnt(struct list_head *target_list,
				struct nocp_cnt *nocp_cnt)
{
