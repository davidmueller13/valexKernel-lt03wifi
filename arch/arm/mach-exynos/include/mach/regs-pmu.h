...
#define S5P_MIPI_DPHY_CONTROL(n)		(soc_is_exynos5250() ? \
...
#define EXYNOS_PMU_CG_STATUS0			EXYNOS_PMUREG(0x0914)
#define EXYNOS_PMU_CG_STATUS1			EXYNOS_PMUREG(0x0918)
#define EXYNOS_PMU_CG_STATUS2			EXYNOS_PMUREG(0x091C)
#define EXYNOS_PMU_CG_STATUS3			EXYNOS_PMUREG(0x0920)
#define EXYNOS_PMU_CG_STATUS4			EXYNOS_PMUREG(0x0924)
...
#define EXYNOS5420_BIAS_CON_ARM				EXYNOS_PMUREG(0x0780)
#define EXYNOS5420_BIAS_CON_INT				EXYNOS_PMUREG(0x0784)
#define EXYNOS5420_BIAS_CON_MIF				EXYNOS_PMUREG(0x0788)
#define EXYNOS5420_BIAS_CON_KFC				EXYNOS_PMUREG(0x078C)
#define EXYNOS5420_BIAS_CON_G3D				EXYNOS_PMUREG(0x0790)
...
/* Only for EXYNOS5420 */
#define EXYNOS5420_CMU_CPU_ACLKSTOP_SYS_PWR_REG			EXYNOS_PMUREG(0x10E0)
#define EXYNOS5420_CMU_CPU_SCLKSTOP_SYS_PWR_REG			EXYNOS_PMUREG(0x10E4)
#define EXYNOS5420_CMU_KFC_ACLKSTOP_SYS_PWR_REG			EXYNOS_PMUREG(0x10F0)
#define EXYNOS5420_RPLL_SYSCLK_SYS_PWR_REG			EXYNOS_PMUREG(0x1174)
#define EXYNOS5420_SPLL_SYSCLK_SYS_PWR_REG			EXYNOS_PMUREG(0x1178)
#define EXYNOS5420_INTRAM_MEM_SYS_PWR_REG			EXYNOS_PMUREG(0x11B8)
#define EXYNOS5420_INTROM_MEM_SYS_PWR_REG			EXYNOS_PMUREG(0x11BC)
#define EXYNOS5420_PAD_RETENTION_JTAG_SYS_PWR_REG		EXYNOS_PMUREG(0x1208)
#define EXYNOS5420_PAD_RETENTION_GPIO_SYS_PWR_REG		EXYNOS_PMUREG(0x1210)
#define EXYNOS54XX_PAD_RETENTION_DRAM_SYSMEM_SYS_PWR_REG	EXYNOS_PMUREG(0x1234)
#define EXYNOS5420_DISP1_SYS_PWR_REG				EXYNOS_PMUREG(0x1410)
#define EXYNOS5420_MAU_SYS_PWR_REG				EXYNOS_PMUREG(0x1414)
#define EXYNOS5420_G2D_SYS_PWR_REG				EXYNOS_PMUREG(0x1418)
#define EXYNOS5420_MSC_SYS_PWR_REG				EXYNOS_PMUREG(0x141C)
#define EXYNOS5420_FSYS_SYS_PWR_REG				EXYNOS_PMUREG(0x1420)
#define EXYNOS5420_FSYS2_SYS_PWR_REG				EXYNOS_PMUREG(0x1424)
#define EXYNOS5420_PSGEN_SYS_PWR_REG				EXYNOS_PMUREG(0x1428)
#define EXYNOS5420_PERIC_SYS_PWR_REG				EXYNOS_PMUREG(0x142C)
#define EXYNOS5420_WCORE_SYS_PWR_REG				EXYNOS_PMUREG(0x1430)
#define EXYNOS5420_CMU_CLKSTOP_DISP1_SYS_PWR_REG		EXYNOS_PMUREG(0x1490)
#define EXYNOS5420_CMU_CLKSTOP_MAU_SYS_PWR_REG			EXYNOS_PMUREG(0x1494)
#define EXYNOS5420_CMU_CLKSTOP_G2D_SYS_PWR_REG			EXYNOS_PMUREG(0x1498)
#define EXYNOS5420_CMU_CLKSTOP_MSC_SYS_PWR_REG			EXYNOS_PMUREG(0x149C)
#define EXYNOS5420_CMU_CLKSTOP_FSYS_SYS_PWR_REG			EXYNOS_PMUREG(0x14A0)
#define EXYNOS5420_CMU_CLKSTOP_FSYS2_SYS_PWR_REG		EXYNOS_PMUREG(0x14A4)
#define EXYNOS5420_CMU_CLKSTOP_PSGEN_SYS_PWR_REG		EXYNOS_PMUREG(0x14A8)
#define EXYNOS5420_CMU_CLKSTOP_PERIC_SYS_PWR_REG		EXYNOS_PMUREG(0x14AC)
#define EXYNOS5420_CMU_CLKSTOP_WCORE_SYS_PWR_REG		EXYNOS_PMUREG(0x14B0)
#define EXYNOS5420_CMU_SYSCLK_TOPPWR_SYS_PWR_REG		EXYNOS_PMUREG(0x14BC)
#define EXYNOS5420_CMU_SYSCLK_DISP1_SYS_PWR_REG			EXYNOS_PMUREG(0x14D0)
#define EXYNOS5420_CMU_SYSCLK_MAU_SYS_PWR_REG			EXYNOS_PMUREG(0x14D4)
#define EXYNOS5420_CMU_SYSCLK_G2D_SYS_PWR_REG			EXYNOS_PMUREG(0x14D8)
#define EXYNOS5420_CMU_SYSCLK_MSC_SYS_PWR_REG			EXYNOS_PMUREG(0x14DC)
#define EXYNOS5420_CMU_SYSCLK_FSYS_SYS_PWR_REG			EXYNOS_PMUREG(0x14E0)
#define EXYNOS5420_CMU_SYSCLK_FSYS2_SYS_PWR_REG			EXYNOS_PMUREG(0x14E4)
#define EXYNOS5420_CMU_SYSCLK_PSGEN_SYS_PWR_REG			EXYNOS_PMUREG(0x14E8)
#define EXYNOS5420_CMU_SYSCLK_PERIC_SYS_PWR_REG			EXYNOS_PMUREG(0x14EC)
#define EXYNOS5420_CMU_SYSCLK_WCORE_SYS_PWR_REG			EXYNOS_PMUREG(0x14F0)
#define EXYNOS5420_CMU_SYSCLK_SYSMEM_TOPPWR_SYS_PWR_REG		EXYNOS_PMUREG(0x14F4)
#define EXYNOS5420_CMU_RESET_FSYS2_SYS_PWR_REG			EXYNOS_PMUREG(0x1570)
#define EXYNOS5420_CMU_RESET_PSGEN_SYS_PWR_REG			EXYNOS_PMUREG(0x1574)
#define EXYNOS5420_CMU_RESET_PERIC_SYS_PWR_REG			EXYNOS_PMUREG(0x1578)
#define EXYNOS5420_CMU_RESET_WCORE_SYS_PWR_REG			EXYNOS_PMUREG(0x157C)
#define EXYNOS5420_CMU_RESET_DISP1_SYS_PWR_REG			EXYNOS_PMUREG(0x1590)
#define EXYNOS5420_CMU_RESET_MAU_SYS_PWR_REG			EXYNOS_PMUREG(0x1594)
#define EXYNOS5420_CMU_RESET_G2D_SYS_PWR_REG			EXYNOS_PMUREG(0x1598)
#define EXYNOS5420_CMU_RESET_MSC_SYS_PWR_REG			EXYNOS_PMUREG(0x159C)
#define EXYNOS5420_CMU_RESET_FSYS_SYS_PWR_REG			EXYNOS_PMUREG(0x15A0)
#define EXYNOS5420_ISP_ARM_SYS_PWR_REG				EXYNOS_PMUREG(0x1090)
#define EXYNOS5420_G2D_CONFIGURATION				EXYNOS_PMUREG(0x4100)
#define EXYNOS5420_G2D_STATUS					EXYNOS_PMUREG(0x4104)
#define EXYNOS5420_G2D_OPTION					EXYNOS_PMUREG(0x4108)
#define EXYNOS5420_MSC_CONFIGURATION				EXYNOS_PMUREG(0x4120)
#define EXYNOS5420_MSC_STATUS					EXYNOS_PMUREG(0x4124)
#define EXYNOS5420_MSC_OPTION					EXYNOS_PMUREG(0x4128)
#define EXYNOS5420_FSYS_CONFIGURATION				EXYNOS_PMUREG(0x4140)
#define EXYNOS5420_FSYS_STATUS					EXYNOS_PMUREG(0x4144)
#define EXYNOS5420_FSYS_OPTION					EXYNOS_PMUREG(0x4148)
#define EXYNOS5420_FSYS2_CONFIGURATION				EXYNOS_PMUREG(0x4160)
#define EXYNOS5420_FSYS2_STATUS					EXYNOS_PMUREG(0x4164)
#define EXYNOS5420_FSYS2_OPTION					EXYNOS_PMUREG(0x4168)
#define EXYNOS5420_PSGEN_CONFIGURATION				EXYNOS_PMUREG(0x4180)
#define EXYNOS5420_PSGEN_STATUS					EXYNOS_PMUREG(0x4184)
#define EXYNOS5420_PSGEN_OPTION					EXYNOS_PMUREG(0x4188)
#define EXYNOS5420_PERIC_CONFIGURATION				EXYNOS_PMUREG(0x41A0)
#define EXYNOS5420_PERIC_STATUS					EXYNOS_PMUREG(0x41A4)
#define EXYNOS5420_PERIC_OPTION					EXYNOS_PMUREG(0x41A8)
#define EXYNOS5420_SFR_AXI_CGDIS1_REG				EXYNOS_PMUREG(0x15E4)
#define EXYNOS5420_FSYS2_OPTION_REG				EXYNOS_PMUREG(0x4168)
#define EXYNOS5420_PSGEN_OPTION_REG				EXYNOS_PMUREG(0x4188)
#define EXYNOS5420_MSC_OPTION					EXYNOS_PMUREG(0x4128)
#define EXYNOS5420_G2D_OPTION					EXYNOS_PMUREG(0x4108)

#define EXYNOS5420_USE_RETENTION				(1<<3)
#define EXYNOS5420_EMULATION					(1<<31)
#define EXYNOS5420_UFS						(1<<8)
#define EXYNOS5420_ACE_KFC					(1<<14)
#define EXYNOS5420_ACE_EAGLE					(1<<15)
#define EXYNOS5420_ATB_ISP_ARM					(1<<19)
#define EXYNOS5420_ATB_KFC					(1<<13)

/* ISP POWER OPTION */
#define EXYNOS5420_LPI_MASK0				EXYNOS_PMUREG(0x0004)
#define EXYNOS5420_LPI_MASK0_FD				(1 << 18) /* FD */
#define EXYNOS5420_LPI_MASK0_OTHERS			( \
							(1 << 11) | /* ISP */ \
							(1 << 12) | /* DRC */ \
							(1 << 13) | /* SCC */ \
							(1 << 14) | /* ODC */ \
...
#define EXYNOS5420_CG_STATUS0				EXYNOS_PMUREG(0x0914)

#define EXYNOS5420_LPI_BUS_MASK0			EXYNOS_PMUREG(0x15A4)
#define EXYNOS5420_LPI_BUS_MASK0_ISP0			(1 << 13)
#define EXYNOS5420_LPI_BUS_MASK0_ISP1			(1 << 14)
#define EXYNOS5420_LPI_BUS_MASK0_RSTOP_ISP		(1 << 15)
#define EXYNOS5420_LPI_BUS_MASK0_PRSTOP_ISP		(1 << 16)

#define EXYNOS5420_ISP_ARM_OPTION			EXYNOS_PMUREG(0x2488)

#define EXYNOS5_APLL_SYSCLK_CONFIGURATION			EXYNOS_PMUREG(0x2A00)
#define EXYNOS5_APLL_SYSCLK_STATUS				EXYNOS_PMUREG(0x2A04)
